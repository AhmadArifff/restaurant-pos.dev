...
// Main Stock
export const getMainStockSummary  = ()       => api.get('/main-stock/summary');
...
// Di lib/api.js
export const getMainStockDaily = (params) => api.get('/main-stock/daily', { params });
export const addStockPurchase     = (data)   => api.post('/main-stock/purchase', data);

// Stock Requests
export const submitStockRequest  = (data)   => api.post('/stock-requests', data);
...
export const addManualStockOut   = (data)      => api.post('/main-stock/out', data);
...
export const downloadBusinessAnalysisPdf = (params) =>
  api.get('/reports/business-analysis/pdf', { params, responseType: 'blob' });
...
export const clearAIChatSession = (sessionId) => api.delete(`/ai-chat/session/${sessionId}`);

export const getAIChatSessions = () => api.get('/ai-chat/sessions');

// Customer table ordering
export const getPublicDiningTables = () => api.get('/customer/tables');
export const getDiningTableByToken = (token) => api.get(`/customer/tables/${token}`);
export const getCustomerMenu = () => api.get('/customer/menu');
